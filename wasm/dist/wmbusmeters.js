...
var ASM_CONSTS = {
  742320: ($0, $1, $2, $3, $4) => { if (typeof queueBaudrateChange === 'function') return queueBaudrateChange($0, $1, $2, $3, $4); return 0; },  
 742429: ($0) => { return (typeof serialPortReady !== 'undefined' && serialPortReady[$0]) ? 1 : 0; },  
 742513: ($0) => { serialPortReady[$0] = false; },  
 742546: ($0, $1, $2) => { writeSerial($0, $1, $2); },  
 742575: () => { return (typeof pendingDisconnects !== 'undefined') ? pendingDisconnects.length : 0; },  
 742663: ($0) => { return pendingDisconnects[$0]; },  
 742698: ($0) => { pendingDisconnects.splice(0, $0); },  
 742736: () => { return (typeof pendingConnects !== 'undefined') ? pendingConnects.length : 0; },  
 742818: ($0) => { return pendingConnects[$0]; },  
 742850: ($0) => { pendingConnects.splice(0, $0); },  
 742885: ($0) => { try { FS.createDevice('/dev', 'ttyWebUSB' + $0, function() { return null; }, function(c) {} ); } catch(e) { console.warn('[vfs] createDevice /dev/ttyWebUSB' + $0 + ' failed:', e); } },  
 743071: ($0) => { try { FS.unlink('/dev/ttyWebUSB' + $0); } catch(e) {} },  
 743129: ($0) => { if (typeof drainSerialData === 'function') drainSerialData($0); }
};
